...
public class Asteroid extends Sprite {
    ...
    public Asteroid(GameController gameController, GameEngine gameEngine) {
        super(gameEngine, R.drawable.meteor_small, BodyType.Circular);

        speed = Configurations.ASTEROID_SPEED * pixelFactor / 1000d;
        this.gameController = gameController;

        this.trailParticleSystem = new ParticleSystem(gameEngine, 50, R.drawable.particle_dust, 600)
    ...
    public void onRemovedFromGameEngine() {
        gameController.returnAsteroidToPool(this);
    }
